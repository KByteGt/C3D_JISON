...
yy: {},
symbols_: {"error":2,"ini":3,"E":4,"EOF":5,"MAS":6,"T":7,"MENOS":8,"POR":9,"F":10,"DIVIDIDO":11,"PARIZQ":12,"PARDER":13,"IDENTIFICADOR":14,"ENTERO":15,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"MAS",8:"MENOS",9:"POR",11:"DIVIDIDO",12:"PARIZQ",13:"PARDER",14:"IDENTIFICADOR",15:"ENTERO"},
...
case 10:return 5;
break;
case 11: console.error('Error léxico: ' + yy_.yytext + ', Linea: ' + yy_.yylloc.first_line + ', Columna: ' + yy_.yylloc.first_column); 
break;
}
},
rules: [/^(?:\()/i,/^(?:\))/i,/^(?:\+)/i,/^(?:-)/i,/^(?:\*)/i,/^(?:\/)/i,/^(?:[ \r\t]+)/i,/^(?:\n)/i,/^(?:[0-9]+\b)/i,/^(?:([a-zA-Z])[a-zA-Z0-9_]*)/i,/^(?:$)/i,/^(?:.)/i],
